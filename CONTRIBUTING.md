...
```bash
git clone https://github.com/ArcavenAE/sideshow.git
cd sideshow
just build    # Build
just test     # Run tests
...
Open a [Bug Report](https://github.com/ArcavenAE/sideshow/issues/new?template=bug-report.yml) and include:
...
Open a [Feature Request](https://github.com/ArcavenAE/sideshow/issues/new?template=feature-request.yml).
